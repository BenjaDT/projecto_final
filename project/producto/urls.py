...
urlpatterns = [
    ...
    path('provedor/actualizar/<int:pk>', views.provedor_actualizar, name='provedor_actualizar'), #solo deberia ser accesible por admin
    path('provedor/eliminar/<int:pk>', views.provedor_eliminar, name='provedor_eliminar'), #solo deberia ser accesible por admin
